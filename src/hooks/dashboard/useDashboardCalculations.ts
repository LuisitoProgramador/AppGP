...
import { agruparPorCategoria } from '../../utils/gastos/agruparPorCategoria'
...
import { buildEvolucionMensual } from '../../utils/dashboard/evolucionMensual'
import { mergeResumenWithOptimistic } from '../../utils/gastos/optimisticGastos'
import { calcularCompromisosMsi } from '../../utils/gastos/msiCompromisos'
import { calcularSaludAhorro } from '../../utils/dashboard/saludAhorro'
import { shouldShowBurnRateAlert } from '../../utils/dashboard/burnRate'
import { proyectarDiaAgotamiento } from '../../utils/dashboard/limitProjection'
import { calcProyeccionCierre } from '../../utils/dashboard/proyeccionCierre'
import {
  buildResumenFinMes,
  mesParaResumenFinMes,
  shouldShowResumenFinMes,
} from '../../utils/dashboard/resumenFinMes'
